...
<form action="" method="post">
    <!--title   -->
    <div class="min-post">
    <label for="title"><h3>edit title</h3></label><br>
    <input type="text" name="title" id="title"><br>

    
    <label for="text"><h3>edit text</h3></label><br>
    <textarea name="text_post" id="text" cols="30" rows="10"></textarea><br>

    <label for="fileup"><h3>edit image or vedio</h3></label><br>
...
<div class="page_cat_post">
  ...
  <input type="checkbox" name="pages" id="pages" value="page1"><br>
<br><br>
<input type="submit"  name="edit_post" value="puplisher" class="btn btn-info btn-lg">
</div>
</div>
    </form>
    </div>
